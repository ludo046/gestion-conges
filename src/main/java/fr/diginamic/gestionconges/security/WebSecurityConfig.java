...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService(DataSource ds) {
        ...
        manager.setUsersByUsernameQuery("select identifiant, mot_de_passe, 'true' from collaborateur where identifiant=?");
        manager.setAuthoritiesByUsernameQuery("select c.identifiant, c.role from collaborateur c where c.identifiant=?");
        return manager;
    }
